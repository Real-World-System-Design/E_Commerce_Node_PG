...
let Product = class Product {
    constructor(name, price, image, description, manufacturer) {
        this.name = name;
        this.price = price;
        this.image = image;
...
__decorate([
    typeorm_1.Column({ nullable: false, width: 20, type: 'text' }),
...
__decorate([
    typeorm_1.Column({ width: 50, nullable: false, type: 'text' }),
    __metadata("design:type", String)
